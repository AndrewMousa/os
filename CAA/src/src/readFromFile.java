...
public class readFromFile {
	...
	public void readGivenFile() throws FileNotFoundException {
		...
		regi.generalregister[0] = 0 ;  //1
		regi.generalregister[1] = 2;   //2
		regi.generalregister[2] = 8;   //3
		regi.generalregister[3] = 4;   //4
		//regi.generalregister[4] ;    //5
		regi.generalregister[5] = 5;   //6

		excute e = new excute(memory, regi);
		e.excute1();
		System.out.println(e.re.generalregister[0]+" r3 is "+ e.re.generalregister[3]);
